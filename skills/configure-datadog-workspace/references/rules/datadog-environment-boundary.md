...
- RunWhen resources, SLXs, tasks and issues here describe {{WORKSPACE_ENV}}. The Datadog MCP server (`/mcp/datadog/`) describes {{DD_ENV_LABEL}}. Different estates, different names: never assume a workspace resource exists in Datadog under the same name.
